...
```mermaid
flowchart TD
  A["Pulsión"] --> B["4 términos y 4 destinos"]
  A --> C["Sexualidad infantil"]
  C --> D["3 caracteres y 3 teorías"]
  C --> E["Fantasía"]
  C --> F["Narcisismo"]
  F --> G["2 libidos, 2 elecciones, 3 ideales"]
  A --> H["Represión"]
  H --> I["3 fases, 2 fuerzas, 2 características"]
  H --> J["Sistema inconsciente"]
  J --> K["3 sentidos y propiedades"]
  H --> L["Síntoma"]
  L --> M["Formación y satisfacción sustitutiva"]
  L --> N["Transferencia"]
