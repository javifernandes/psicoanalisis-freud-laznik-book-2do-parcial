...
```mermaid
flowchart TD
  A["Ojo"] --> B["Función yoica<br/>orientación y conservación"]
  A --> C["Función sexual<br/>placer de ver"]
  B --> D["Conflicto pulsional"]
  C --> D
  D --> E["Represión de la satisfacción sexual"]
  E --> F["Perturbación de la función del órgano"]
```
...
```mermaid
flowchart LR
  A["Pulsiones yoicas vs. sexuales"] --> B["Conflicto en el órgano"]
  B --> C["Ceguera histérica"]
  A --> D["Problema: el Yo también puede ser objeto de libido"]
  D --> E["Narcisismo"]
```
